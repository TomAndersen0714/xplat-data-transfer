...
ch_tmp_local_table = 'tmp.xdqc_tb_task_record_daily_local'
ch_tmp_dist_table = 'tmp.xdqc_tb_task_record_daily_all'
ch_dest_local_table = 'xqc_ods.xdqc_tb_task_record_local'
ch_dest_dist_table = 'xqc_ods.xdqc_tb_task_record_all'
...
partition = " '%s',intDiv({{ ds_nodash }},100) " % 'tb'
