...
-- Create local table
/* DROP TABLE xqc_ods.xdqc_kefu_stat_local ON CLUSTER cluster_3s_2r */
...
/* DROP TABLE xqc_ods.xdqc_kefu_stat_all ON CLUSTER cluster_3s_2r; */
...
-- Create Buffer Table For Inserction
CREATE TABLE buffer.xdqc_kefu_stat_buffer ON CLUSTER cluster_3s_2r
AS xqc_ods.xdqc_kefu_stat_all
ENGINE = Buffer('xqc_ods', 'xdqc_kefu_stat_all', 16, 10, 30, 81920, 409600, 67108864, 134217728);
